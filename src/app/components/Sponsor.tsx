...
function Sponsor() {
    ...
    const testimonials = [
      {
        url: "https://th.bing.com/th/id/OIP.kaXXjkGSpi9kFJYtYsWRqAAAAA?rs=1&pid=ImgDetMain",
      },
      {
        url: "https://freepngdesign.com/content/uploads/images/walmart-logo-5340.png",
      },
    ];
  return (
     <motion.div 
